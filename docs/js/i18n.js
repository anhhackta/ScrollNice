...
const TRANSLATIONS = {
    vi: {
        ...
        roadmap_title: 'Lộ trình Slint UI Migration',
        roadmap_sub: 'Thiết kế mới ưu tiên Fluent UI, đa ngôn ngữ và cấu hình theo profile.',
        roadmap_p1_title: 'Core Rust Foundation',
        roadmap_p1_body: 'Chuẩn hóa ConfigStore, ScrollEngine, ZoneManager và StateMachine.',
        roadmap_p2_title: 'Slint UI + Theme',
        roadmap_p2_body: 'MainWindow/Overlay mới với light-dark theme đồng bộ toàn ứng dụng.',
        roadmap_p3_title: 'i18n + Presets + Profiles',
        roadmap_p3_body: 'Bổ sung song ngữ EN/VI, preset cho app phổ biến và profile tùy biến.',
        roadmap_p4_title: 'Wheel Block + Auto Target',
        roadmap_p4_body: 'Hoàn thiện chặn wheel theo mode và tự nhận diện cửa sổ cuộn.',
    ...
    en: {
        ...
        roadmap_title: 'Slint UI Migration Roadmap',
        roadmap_sub: 'The new direction prioritizes Fluent UI, bilingual support, and profile-based configuration.',
        roadmap_p1_title: 'Core Rust Foundation',
        roadmap_p1_body: 'Standardize ConfigStore, ScrollEngine, ZoneManager, and StateMachine.',
        roadmap_p2_title: 'Slint UI + Theme',
        roadmap_p2_body: 'New MainWindow/Overlay with synchronized light/dark theming.',
        roadmap_p3_title: 'i18n + Presets + Profiles',
        roadmap_p3_body: 'Deliver EN/VI support, app presets, and customizable user profiles.',
        roadmap_p4_title: 'Wheel Block + Auto Target',
        roadmap_p4_body: 'Finalize wheel blocking modes and automatic scroll target detection.',
